-- Table: public.tr_asset

-- DROP TABLE IF EXISTS public.tr_asset;

CREATE TABLE IF NOT EXISTS public.tr_asset
(
    id serial,
    ...
    nama_aset character varying(255) COLLATE pg_catalog."default",
    kd_jenis_aset character varying(20) COLLATE pg_catalog."default",
    ...
    CONSTRAINT tr_asset_pkey PRIMARY KEY (id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.tr_asset
    OWNER to postgres;