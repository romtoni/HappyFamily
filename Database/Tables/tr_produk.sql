-- Table: public.tr_produk

-- DROP TABLE IF EXISTS public.tr_produk;

CREATE TABLE IF NOT EXISTS public.tr_produk
(
    id serial,
    ...
    kd_jenis_produk character varying(20) COLLATE pg_catalog."default",
    ...
    CONSTRAINT tr_produk_pkey PRIMARY KEY (id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.tr_produk
    OWNER to postgres;