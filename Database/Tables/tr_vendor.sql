-- Table: public.tr_vendor

-- DROP TABLE IF EXISTS public.tr_vendor;

CREATE TABLE IF NOT EXISTS public.tr_vendor
(
    id serial,
    ...
    CONSTRAINT tr_vendor_pkey PRIMARY KEY (id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.tr_vendor
    OWNER to postgres;