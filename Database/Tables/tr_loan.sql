-- Table: public.tr_loan

-- DROP TABLE IF EXISTS public.tr_loan;

CREATE TABLE IF NOT EXISTS public.tr_loan
(
    id serial,
    ...
    nama_pinjaman character varying(255) COLLATE pg_catalog."default",
    kd_jenis_pinjaman character varying(20) COLLATE pg_catalog."default",
    ...
    CONSTRAINT tr_loan_pkey PRIMARY KEY (id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.tr_loan
    OWNER to postgres;