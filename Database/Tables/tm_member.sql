...
(
    id integer NOT NULL DEFAULT nextval('tm_member_id_seq'::regclass),
    ...
    tanggal_lahir date,
    agama character varying(3) COLLATE pg_catalog."default",
    st_pernikahan character varying(3) COLLATE pg_catalog."default",
    tgl_pernikahan date,
